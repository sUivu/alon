...
def add_train_args(parser: ArgumentParser):
    ...
    parser.add_argument('--model_type', type=str, default='LiftMP', choices=['LiftMP', "ALMGNN", "ALMGNN_V2", 'FullMP', 'GIN',"ALMGIN","ALMGatedGCNN","ALMGAT","ALMGCNN", 'GAT', 'GCNN', 'GatedGCNN', 'NegationGAT', 'ProjectMP', 'Nikos'],
