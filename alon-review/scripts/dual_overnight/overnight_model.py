...
Extends model/pdgno_upgrade.py (imported READ-ONLY) with one new norm mode:
...
from model.pdgno_a_fair import EPS  # noqa: E402
from model.pdgno_upgrade import (  # noqa: E402,F401
    UpgradeALMGNN, arm_spec,
)
...
class DualGraphALMGNN(nn.Module):
...
def build_overnight_network(cfg, problem, rank, num_layers, lift_ratio,
    ...
    from model.pdgno_upgrade import UpgradeALMGNN
    ...
    if cfg['norm'] == 'dualgraph':
        return DualGraphALMGNN(grad, in_channels=rank, num_layers=num_layers,
