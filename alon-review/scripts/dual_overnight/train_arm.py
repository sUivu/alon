...
Training loop = verbatim upgrade-campaign loop (train_alon_upgrade.py /
...
with the arm's lambda_freq / rho / tau / mu_mode / warmup.  The paper
(Eq. (7)/(10), Alg. 1) requires a positive penalty coefficient rho > 0.
...
Usage:
  ...
  python scripts/dual_overnight/train_arm.py \
