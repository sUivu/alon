#!/usr/bin/env python3
"""matrix-fill: T1-config ALON training for grid rows missing from
train_alon_upgrade.DATASET_SPECS.
...
linear_annealing -- the validated main-table ALON arm.

Namespace (isolated, non-colliding):
  ckpts/dual_overnight_T1_<ROW>_s<seed>/alon_upgrade.pt
...
Usage:
  ...
  python scripts/matrix_fill/train_t1.py \
...
import train_alon_upgrade as U  # noqa: E402
