#!/usr/bin/env python3
"""
ALON-A FAIR bake-off -- evaluation.  Identical protocol for every candidate.
...
-----
  ...
  python scripts/eval_alon_a_fair.py \
      --checkpoint ckpts/alon_a_fair_C1_PROTEINS_seed0/alon_a_fair.pt \
...
from model.alon_a_fair import (  # noqa: E402
    spec_of, build_network, ALONA_Fair, make_batch_graphs, eval_config,
    ...
    for split in cli.splits:
        ...
        def run(name, K, rho, use_mu_phi, statusquo=False):
            ...
            rows, mh, rh = eval_config(
                alon, x_in, big, graphs, offsets, K, rho,
