...
changes is identical across arms:
  ...
  * 200 epochs, lr 1e-3, grad_clip 5, penalty annealing +0.5 -> +2.5 linear
    (positive schedule; the paper requires a positive penalty rho > 0),
    batch size per dataset (PROTEINS 9,
...
1000 hyperplanes -> paper greedy repair (add the vertex covering the most
currently-uncovered edges, lowest-index tie-break; violation == 0 asserted).
